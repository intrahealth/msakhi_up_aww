...
public class FoodPregFragment extends Fragment {
	Cursor cursor;
   ...
   return v;
			...
			public void onClick(View v) {
	          for(PregInfo preg:prg_list)
	          {
	        	  ...
	        	  try {
					...
					Log.e("server_id", preg.getServer_id()+"");
					json.put("food",preg.getFood());
					json.put("weight_food",preg.getWeight_food());
					Log.e("food_weight", preg.getWeight_food()+"");
					json.put("weight_size",preg.getWeight_size());
					Log.e("food_weight", preg.getWeight_size()+"");
					json.put("id",preg.getId());
					Log.e("datajson","jsonObject"+json.toString());
	...
	private void getAllPregList() {
		...
		cursor=obj_Db.getAllPregFoodRecordList();
